...
**Result:** Let's see how to [Create a page](/textbook-generation/textbooks/tutorial-basics/create-a-page).
## Images​
...
[Edit this page](https://github.com/facebook/docusaurus/tree/main/packages/create-docusaurus/templates/shared/docs/tutorial-basics/markdown-features.mdx)
  * Front Matter
  * Links
  * Images
  * Code Blocks
